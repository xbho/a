...
net config server /srvcomment:"2333" > out.txt 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V EnableAutoTray /T REG_DWORD /D 0 /F > out.txt 2>&1
net user administrator SS2q@5e#m3H@U /add >nul
...
echo Successfully Installed!, If Dead, Please Rebuild Again!
echo IP:
